...
const styles = (theme) => ({
  ...
  g: {
    ...
    text: {
      shadow: {
        textShadow: "0.025em 0.04em 0 #555",
      },
    },
  },
  rect: {
...
class HeatMapChartD3 extends Component {
  constructor(props) {
    super(props);
    ...
    let chart = () => {
      ...
      const leaf = svg
        ...
        .on("mousemove", function (d) {
          // console.log(d)
          tooltip.transition().duration(300).style("opacity", 0.98);
          tooltip
            .html(
              `<div class="tooltip-body" data-id=${d.data.name} >
            <ul>
  ...
  // ZOOM Function
  instance = panzoom(document.getElementById("chart"), {
    zoomSpeed: 0.06,
    maxZoom: 20,
    minZoom: 1,
  });
  ...
  render() {
    ...
    const chartDiv = this.document.getElementById("root");
    ...
    return <div id={"root"} className={classes.root}></div>;
  }
}

export default withStyles(styles)(HeatMapChartD3);
